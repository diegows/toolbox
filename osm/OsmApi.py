...
#Node id=308990306 lat=-34.712478 lon=-58.3948548
    MyApi = OsmApi(username = u"diegows", password = u"asas7189")
    data = MyApi.Map(-58.3988571,-34.7314556,-58.3786011,-34.682911)
    data = MyApi.Map(-34.7156599805, -58.3980367805, -34.7092960195,
                        -58.3916728195)
    print dat
    for object in data:
        if object['type'] == 'way' and object['data']['tag'].has_key('name'):
            try:
                print 'XXX', object['data']['tag']['name']
            except:
                print 'UPS'
